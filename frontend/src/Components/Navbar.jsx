...
import { FiMenu, FiX, FiUser, FiHome, FiCalendar, FiUsers, FiBriefcase, FiSend, FiLogOut, FiChevronDown, FiBell, FiSettings } from "react-icons/fi";
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        {isAuthenticated && (
                            <div className="hidden md:flex items-center gap-1">
                                ...
                                >
                                    <span className="flex items-center gap-2">
                                        <FiCalendar className="text-sm" /> Events
                                    </span>
                                </NavLink>
                                {id && (
                                    <>
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        {isAuthenticated ? (
                            ...
                            <Link
                                to="/login"
                                className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-medium rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg shadow-blue-500/25"
                            >
                                Sign In
                            </Link>
                        )}
                        ...
                        <div className="px-4 py-3 space-y-1">
                            ...
                            {isAuthenticated && (
                                <div className="pt-3 border-t border-gray-100">
                                    ...
                                    <button
                                        onClick={handleLogout}
                                        className="w-full text-left px-4 py-3 text-base font-medium text-red-600 hover:bg-red-50 flex items-center gap-3"
                                    >
